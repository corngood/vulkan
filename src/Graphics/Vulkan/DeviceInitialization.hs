...
data VkPhysicalDeviceLimits =
  VkPhysicalDeviceLimits{ maxImageDimension :: Word32 
                        , maxImageDimension :: Word32 
                        , maxImageDimension :: Word32 
...
instance Storable VkPhysicalDeviceLimits where
  ...
  poke ptr poked = poke (ptr `plusPtr` 0) (maxImageDimension (poked :: VkPhysicalDeviceLimits))
                *> poke (ptr `plusPtr` 4) (maxImageDimension (poked :: VkPhysicalDeviceLimits))
                *> poke (ptr `plusPtr` 8) (maxImageDimension (poked :: VkPhysicalDeviceLimits))
...
data VkPhysicalDeviceSparseProperties =
  VkPhysicalDeviceSparseProperties{ residencyStandard :: VkBool32 
                                  , residencyStandard :: VkBool32 
                                  , residencyStandard :: VkBool32 
...
instance Storable VkPhysicalDeviceSparseProperties where
  ...
  peek ptr = VkPhysicalDeviceSparseProperties <$> peek (ptr `plusPtr` 0)
                                              ...
                                              <*> peek (ptr `plusPtr` 12)
                                              <*> peek (ptr `plusPtr` 16)
  poke ptr poked = poke (ptr `plusPtr` 0) (residencyStandard (poked :: VkPhysicalDeviceSparseProperties))
                *> poke (ptr `plusPtr` 4) (residencyStandard (poked :: VkPhysicalDeviceSparseProperties))
                *> poke (ptr `plusPtr` 8) (residencyStandard (poked :: VkPhysicalDeviceSparseProperties))
