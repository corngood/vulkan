...
import Graphics.Vulkan.Raw.ImageView( VkImageView(..)
                                    )
import Graphics.Vulkan.Raw.BufferView( VkBufferView(..)
                                     )
...
import Graphics.Vulkan.Raw.Image( VkImageLayout(..)
                                )
...
import Graphics.Vulkan.Raw.Sampler( VkSampler(..)
                                  )
