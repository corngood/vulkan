...
import Graphics.Vulkan.Raw.CommandPool( VkCommandPool(..)
                                      )
import Graphics.Vulkan.Raw.Device( VkDevice(..)
                                 )
import Graphics.Vulkan.Raw.Pass( VkFramebuffer(..)
                               , VkRenderPass(..)
                               )
...
import Graphics.Vulkan.Raw.Query( VkQueryPipelineStatisticFlags(..)
