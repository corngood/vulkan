...
data VkPhysicalDeviceFeatures =
  VkPhysicalDeviceFeatures{ robustBufferAccess :: VkBool32 
                          ...
                          , textureCompressionETC :: VkBool32 
                          ...
                          , sparseResidencyImage :: VkBool32 
                          , sparseResidencyImage :: VkBool32 
                          , sparseResidency :: VkBool32 
                          , sparseResidency :: VkBool32 
                          , sparseResidency :: VkBool32 
                          , sparseResidency :: VkBool32 
...
instance Storable VkPhysicalDeviceFeatures where
  ...
  poke ptr poked = poke (ptr `plusPtr` 0) (robustBufferAccess (poked :: VkPhysicalDeviceFeatures))
                *> poke (ptr `plusPtr` 4) (fullDrawIndexUint (poked :: VkPhysicalDeviceFeatures))
                ...
                *> poke (ptr `plusPtr` 80) (textureCompressionETC (poked :: VkPhysicalDeviceFeatures))
                ...
                *> poke (ptr `plusPtr` 156) (shaderFloat (poked :: VkPhysicalDeviceFeatures))
                *> poke (ptr `plusPtr` 160) (shaderInt (poked :: VkPhysicalDeviceFeatures))
                *> poke (ptr `plusPtr` 164) (shaderInt (poked :: VkPhysicalDeviceFeatures))
                ...
                *> poke (ptr `plusPtr` 184) (sparseResidencyImage (poked :: VkPhysicalDeviceFeatures))
                *> poke (ptr `plusPtr` 188) (sparseResidencyImage (poked :: VkPhysicalDeviceFeatures))
                *> poke (ptr `plusPtr` 192) (sparseResidency (poked :: VkPhysicalDeviceFeatures))
                *> poke (ptr `plusPtr` 196) (sparseResidency (poked :: VkPhysicalDeviceFeatures))
                *> poke (ptr `plusPtr` 200) (sparseResidency (poked :: VkPhysicalDeviceFeatures))
                *> poke (ptr `plusPtr` 204) (sparseResidency (poked :: VkPhysicalDeviceFeatures))
